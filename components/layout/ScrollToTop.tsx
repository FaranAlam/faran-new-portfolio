    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-40 right-4 z-40 p-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group"
          whileHover={{ y: -5 }}
          whileTap={{ scale: 0.9 }}
        >
          <svg
